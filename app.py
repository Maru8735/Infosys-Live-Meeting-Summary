...
st.markdown("""
<style>
    /* Multi-layered blended background */
    body {
        background-image: 
            linear-gradient(135deg, rgba(138, 43, 226, 0.15) 0%, rgba(30, 144, 255, 0.15) 50%, rgba(255, 69, 0, 0.1) 100%),
            linear-gradient(45deg, rgba(0, 0, 0, 0.2) 0%, rgba(50, 50, 50, 0.1) 100%),
    ...
    [data-testid="stAppViewContainer"] {
        background: 
            linear-gradient(180deg, rgba(0, 0, 0, 0.3) 0%, rgba(10, 14, 39, 0.4) 50%, rgba(0, 0, 0, 0.35) 100%) !important;
